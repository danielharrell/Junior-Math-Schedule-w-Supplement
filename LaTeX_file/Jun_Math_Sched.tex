...
{\small \emph{Note}: On older schedules the Galileo is followed by Lemmas 1-11 of \emph{Principia}---an option that sticks with geometry, in effect, before moving to Leibniz. keeps the readings geometrical TODO Flag Newton lemmas here.}
...
\begin{quote}
\small{\emph{Note}: Another option, found on older schedules, is to read Dedekind second semester, after Newton. This means starting \emph{Principia} first semester, with Lemmas 1--11. (The \emph{Principia} schedule begins on \hyperref[NewtonStart]{page~\pageref{NewtonStart}}.)} 
\end{quote}
\begin{enumerate}[resume*]
