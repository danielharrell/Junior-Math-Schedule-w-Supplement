...
\begin{enumerate}[noitemsep]
  ...
  \item Essays of Leibniz, with notes:
    \begin{enumerate}
      ...
      \item Two essays on the Hanging Chain (optional).
...
\begin{quote}
	\small{\emph{Note}: Another Leibniz reading,
		\href{https://drive.google.com/file/d/13QZpejWT57AqWmNGGDb8XdCr4IoCHV1G/view?usp=sharing}{``An Approach
	to the Arithmetic of Infinites''}, used to precede
	the reading of ``A New Method.'' With time and
	interest this might still be read. For a
	two-day schedule, see
	\hyperref[LeibnizInfinites]{page~\pageref{LeibnizInfinites}}}.
\end{quote}
...
\begin{enumerate}[noitemsep]
	...
	\item Four (or more) days on NE 68--96, along with
		...
		manual.
\end{enumerate}
\textbf{An Approach to the Arithmetic of Infinites} (\href{https://drive.google.com/file/d/13QZpejWT57AqWmNGGDb8XdCr4IoCHV1G/view?usp=sharing}{not in
manual})
\label{LeibnizInfinites}
\begin{enumerate}[noitemsep]
	\item Pages 1--5 (through the paragraph ending next
		to Comment 6).\footnote{Comments 3 and 6
			come up later, but the other
			comments are optional.}
	\item Pages 5--10 (from the first paragraph after
		Comment 6 to the paragraph ending next to
		Comment 7).\footnote{This omits the
			demonstrations of the axioms on
			pages 10–11.}
\end{enumerate}
\textbf{The Hanging Chain problem}
\label{LeibnizHang}
...
Galileo'' \begin{enumerate}[resume*]
...
\textbf{On the True Proportion}
	...
	1--9. \item Continuing from sixth paragraph
	through middle of ninth paragraph (from
	``Accordingly I found'' through the indented and
	italicized ``If the area of the
	inscribed square is $1/4$, etc.''). Notes
	10--12.\footnote{The rest of the paper is omitted.}
\end{enumerate}
...
{\small\emph{Note}: There is no assigned place on this
	...
	the supplement.} \begin{enumerate}[noitemsep] \item
...
\end{quote} \begin{enumerate}[resume*] \item Lemma 3 with
	...
	\item Lemma 11,
		...
		to Lemma 11.  \end{enumerate} \begin{quote}
...
\begin{enumerate}[resume*] \item Proposition 1.  \item
	...
	\item Proposition 6 and Corollary 1.\footnote{A
		...
		Remaining corollaries to Prop.~6.  \item
...
\begin{enumerate}[resume*] \item Proposition
	...
	\item Lemmas 13 and 14. Proposition 13 with
		corollaries.\footnote{\emph{Conics} III.45,
			...
			reviewed here.} \item Propositions
		14 and 15, with their corollaries.  \item
		Proposition 16.  \item Proposition 17.
	\item Review and discussion of Propositions 1--17.
\end{enumerate} \begin{quote} \small{\emph{Note}: This
...
\begin{enumerate}[resume*] \item Preface. Rules.  \item
	...
	\hyperref[supple.79]{page~\pageref{supple.79}} of the
		supplement.}
	\end{quote}	\begin{center} \textsc{\small{Second
				semester: optional
				readings}} \end{center}
	\textbf{\emph{Principia}, Book I, Section 11}
	\label{Newton} \begin{quote} \small{\emph{Note}: In
